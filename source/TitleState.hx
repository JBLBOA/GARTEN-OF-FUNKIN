	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 4:
					deleteCoolText();
					createCoolText(['SRWHITE', 'IKAK', 'ROBERTO', 'JP13XD', 'ELFB34']);
				case 5:
					deleteCoolText();
					createCoolText(['TOMPOOPS', 'VALENTINOBLOXING', 'SIMON', 'FARSY', 'SOFI']);

				// credTextShit.text += '\npresent...';
				// credTextShit.addText();
				case 6:
					deleteCoolText();
					createCoolText(['WILLY', 'ZETA_CLIFF', '4RM4GEDON', 'BAU', 'OSCAR']);
				...
				case 7:
					deleteCoolText();
					createCoolText(['ZEAR', 'OMARA ', 'PANCHO', 'SKATE']);
				case 8:
					deleteCoolText();
				...
				case 16:
					addMoreText('REBANBANED'); // credTextShit.text += '\nFunkin';
				case 17:
					skipIntro();
			}
		}
